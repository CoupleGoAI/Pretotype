            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-invert max-w-none space-y-6 text-base leading-relaxed">
                    ...
                    <section>
                        ...
                        <p>
                            CoupleGoAI ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our AI-powered relationship support services.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. Information We Collect</h2>
                        <h3 className="text-lg font-semibold text-white/90 mt-6 mb-3">2.1 Personal Information</h3>
                        ...
                        <p>
                            Your conversations with our AI may contain sensitive relationship information. This data is encrypted and treated with the highest level of confidentiality. We do not share this information with third parties except as required by law.
                        </p>

                        <h3 className="text-lg font-semibold text-white/90 mt-6 mb-3">2.3 Automatic Information</h3>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            <li><strong>Service Providers:</strong> Third-party vendors who assist in operating our website and conducting our business</li>
                    ...
                    <section>
                        ...
                        <p className="mt-4">
                            Your data is stored on secure servers located in compliant jurisdictions. However, no method of transmission over the Internet is 100% secure.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-4">
                            To exercise these rights, please contact us at couplegoai.main@gmail.com.
                        </p>
                    </section>
